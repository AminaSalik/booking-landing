...
function BookingApp() {
    ...
    const handleVerifyAndBook = async () => {
        ...
        try {
            ...
            triggerToast("Booking Verified! ✅ Click WhatsApp to confirm.", false);
        } catch (error) {
    ...
    const handleWhatsAppClick = (e) => {
        ...
        if (!isVerifiedSuccess) {
            triggerToast("Please complete your booking and verify first", true);
        } else {
            const phone = "212638798360";
            const client = `${firstName} ${lastName}`.toUpperCase();
    ...
    const resetForm = () => {
        ...
        setVerificationCode(''); setGeneratedOtp(''); setIsVerifiedSuccess(false);
    };
    ...
    return (
        <div className="booking-page-wrapper" id="booking-section">
            ...
            <a href="#" onClick={handleWhatsAppClick} className="whatsapp-float">
            ...
            >
                <div className="booking-toast-icon" style={{ backgroundColor: 'rgba(255,255,255,0.2)', width: '25px', height: '25px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    {toastMessage.isError ? '!' : '✓'}
                </div>
                <div className="booking-toast-message" style={{ fontWeight: '600' }}>
                    {toastMessage.text}
                </div>
            </div>
        </div>
